...
def test_SimulatedHashSolver():
    ...
    hash_length = 100
    str_id, hash1 = bhs1.calculate_quantum_hash(hash_length, rng_seed=0)
    print(str_id)
    ...
    _, hash2a = bhs2.calculate_quantum_hash(hash_length, rng_seed=0)
    assert np.array_equal(hash1, hash2a), "Same seed, but not same result"
    _, hash2b = bhs2.calculate_quantum_hash(hash_length, rng_seed=1)
    ...
    _, hash3 = bhs3.calculate_quantum_hash(hash_length, rng_seed=2)
...
def test_QuantumHashSolver():
    ...
    for hash_length in [32, 64]:
        ascii_hash, qhs_hash = qhs.calculate_quantum_hash(hash_length=hash_length, rng_seed=0)
...
def test_initialize_solver_qpu_client():
    ...
    hash_length = 1024
    _, qhs_hash1a = qhs.calculate_quantum_hash(hash_length=hash_length, rng_seed=0)
    _, qhs_hash1b = qhs.calculate_quantum_hash(hash_length=hash_length, rng_seed=0)
    _, qhs_hash2 = qhs.calculate_quantum_hash(hash_length=hash_length, rng_seed=1)
