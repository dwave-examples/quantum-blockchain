...
def test_prng_randomization():
    ...
    TrialManager objects with identical parameters and in particular identical PRNG sseds. If 
    ...
    for parameter_set in parameter_sets:
        ...
        assert manager1.prng_seed == manager2.prng_seed, f"Managers have differing prng seeds of \
                                        {manager1.prng_seed} and {manager2.prng_seed} respectively"
        
        assert manager1.pow.prng_seed == manager2.pow.prng_seed, f"PoWs have differing prng seeds \
                            of {manager1.pow.prng_seed} and {manager2.pow.prng_seed} respectively"
        ...
        for _ in range(num_blocks):
            ...
            for __ in range(parameter_set[1]): # Second param is num_miners. Controls how many 
                ...
                assert active_miner1.mining_hash == active_miner2.mining_hash, f"Active miners \
                                    had different mining hashes of {active_miner1.mining_hash} \
                                                    and {active_miner2.mining_hash} respectively"
                latest_block1 = active_miner1.blockchain.most_recent_block
                latest_block2 = active_miner1.blockchain.most_recent_block
                assert latest_block1 == latest_block2, f"Active miners had different values for \
                    their most recent blocks of {latest_block1} and {latest_block2} respectively"
