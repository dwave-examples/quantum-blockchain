...
def get_trial_params_from_id(trial_id: str) -> dict:
    ...
    and prng_seed will be the same as in the original trial. 
    See generate_trial_id for details on how the trial ID encodes these parameters.
    
    Args:
        trial_id: A hexadecimal string encoding the trial parameters, generated by generate_trial_id.
        
    Returns:
        params_dict: A dictionary of initialization parameters for TrialManager, with the same 
        values as the trial corresponding to the input trial_id."""
